...
export default function Navigation({className, navRemClass}) {
    ...
    return (
        ...
        <Link onClick={navRemClass} to="/" className='nav_link'>Home</Link>
        <Link onClick={navRemClass} to="/store" className='nav_link'>Store</Link>
        {/* <Link to="/about" className='nav_link'>About</Link> */}
        <Link onClick={navRemClass} to="/cart" className='nav_link'>
